...
namespace THUD_TN408.Areas.Admin.Controllers
{
    ...
    public class Products1Controller : Controller
    {
        ...
        public Products1Controller(TN408DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Origin,Description,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Origin,Description,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
